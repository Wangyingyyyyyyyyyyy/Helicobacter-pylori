...
def set_background():
    ...
    .css-rncmk8 {box-shadow: 0.05rem 0.05rem 0.2rem 0.1rem rgb(192, 192, 192);margin:0 calc(20% + 0.5rem);}
...
with st.form("my_form"):
    ...
    if submitted:
        ...
        X = pd.DataFrame([[a, b, c, d, e, f, g, h, i, j]],
                         columns=['group_354', 'hyuA K524E', 'group_667', 'group_1303', 'pabC E150A', 'omp18 K168R', 'HP0415 T247M', 'group_1307', 'group_541', 'omp13 G211A'])
        ...
        with st.spinner('force plot generation, please wait...'):
            ...
            shap.force_plot(explainer.expected_value, shap_values[0], X.iloc[0].values, feature_names=['group_354', 'hyuA K524E', 'group_667', 'group_1303',
                                                                                                       'pabC E150A', 'omp18 K168R', 'HP0415 T247M', 'group_1307', 'group_541', 'omp13 G211A'], matplotlib=True, show=False, figsize=(20, 5))
